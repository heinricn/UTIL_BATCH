...
###Start of felxible DBase Script Imported Form Stephens work - Nathan Heinrich
...
# Old method of Changing parameters for third replay 
#if [[ $OPT == "HMS" ]]; then
