...
while true; do
    ...
    case $yn in
		...
		#echo "TRACK: debug" >> ${batch} ### Use this track for testing, higher priority
                echo "JOBNAME: BCM_Map_${runNum}" >> ${batch} ## Change to be more specific if you want
		...
		echo "INPUT_FILES: ${tape_file}" >> ${batch}
                echo "COMMAND:/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/Scalar_bcm_map.sh ${runNum} ${MAXEVENTS}"  >> ${batch}
                echo "COMMAND:/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/Scalar_bcm_map.sh ${runNum} ${MAXEVENTS}"
